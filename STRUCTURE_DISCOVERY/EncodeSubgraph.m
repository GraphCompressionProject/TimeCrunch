function [idxMin, exact_found] = EncodeSubgraph( B, curind, top_gccind, N_tot, out_fid, info, minSize )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
idxMin = -1;
exact_found = false;
if(size(top_gccind,1) ~= 1)
	top_gccind = top_gccind';
end
