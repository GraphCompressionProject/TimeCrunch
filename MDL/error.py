...
class Error :
    ...
    def saveOld(self):
        self.numNodesOld = self.numNodes;
        
        self.unmodelledOld = self.unmodelled; 
        self.numUnmodelledErrorsOld = self.numUnmodelledErrors;

        self.modelledOld = self.modelled;
        self.numModellingErrorsOld = self.numModellingErrors;
        
        self.coveredOld = self.covered;
        self.numCellsCoveredOld = self.numCellsCovered;

        self.excludedOld = self.excluded;
        self.numCellsExcludedOld = self.numCellsExcluded;
